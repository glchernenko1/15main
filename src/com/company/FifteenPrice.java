...
/**
 * Вычисляется какое количество клеток, находящихся не на своих местах.
 */
public class FifteenPrice implements Rules<FifteenState> {
	...
	/*
	 * Количество клеток, находящихся не на своих местах.
	 */
	...
	public FifteenPrice(int fieldSize, byte[] terminateState) {
		if (fieldSize < 2) {
